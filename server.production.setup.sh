...
apt-get install git-core curl zlib1g-dev libsqlite3-dev mysql-server build-essential libssl-dev libreadline-gplv2-dev checkinstall apache2 imagemagick libmysqlclient-dev
